...
<div class="wrap">
    ...
    <form action="" method="post">
        ...
        <table class="form-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th scope="row"><label for="buy_now_product_card"><?php _e( 'Enable - card product', 'sovware' ); ?></label></th>
                ...
                <tr>
                    ...
                    <th scope="row"><label for="buy_now_single"><?php _e( 'Enable - single product', 'sovware' ); ?></label></th>
                ...
                <tr>
                    ...
                    <th scope="row"><label for="reset_cart"><?php _e( 'Reset Cart before Buy Now', 'sovware' ); ?></label></th>
                ...
                <tr>
                    ...
                    <th scope="row">
                        <label><?php _e( 'Button Position - card product', 'sovware' ); ?></label>
                    </th>
                ...
                <tr>
                    ...
                    <th scope="row">
                        <label><?php _e( 'Button Position - single product', 'sovware' ); ?></label>
                    </th>
        ...
        <table class="form-table">
            ...
            <h3><?php _e( 'Button Style - card product', 'sovware' ); ?></h3>
        ...
        <table class="form-table">
            ...
            <h3><?php _e( 'Button Style - single product', 'sovware' ); ?></h3>
